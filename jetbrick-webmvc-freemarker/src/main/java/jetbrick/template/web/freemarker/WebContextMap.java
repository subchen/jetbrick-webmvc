 ...
 * @author Guoqiang Chen
 */
public final class WebContextMap extends HashMap<String, Object> {
    ...
    public WebContextMap(HttpServletRequest request, HttpServletResponse response) {
        this(request, response, null);
    }

    public WebContextMap(HttpServletRequest request, HttpServletResponse response, Map<String, Object> context) {
